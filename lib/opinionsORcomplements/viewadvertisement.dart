...
class viewadvertisement extends StatelessWidget{
  @override
  Widget build(BuildContext context) {
    return Scaffold(
        body: FutureBuilder(
          future: FirebaseFirestore.instance.collection('advertisements').get(),
                  ...
                  return Container(
                      child:Column(
                        children: [
                          ...
                          ,Container(
                              child:Center(
                                child:Text(x.data.docs[index]['advertisement']),
                              )
                          )
                          ,Container(
                            height: 20,
